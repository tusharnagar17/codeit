...
const About = () => {
  return (
    <div
      id="about-section"
      className="max-w-6xl mx-auto my-20 px-2 border-b-[0.1px]"
    >
      <div className="text-5xl font-bold my-5">About:</div>
      <div className="md:flex md:justify-around md:items-center">
        ...
        <div className="">
          <div className="text-5xl font-bold text-wrap my-8 text-center text-red-400">
          ...
          <div className="mx-8 font-semibold">
            ...
            <br />
            We follow designing and developing app both for Android / IOS and
            website.
            <br />
